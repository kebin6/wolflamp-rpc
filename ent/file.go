...
func (e FileEdges) BannerOrErr() (*Banner, error) {
	if e.Banner != nil {
		return e.Banner, nil
...
// QueryBanner queries the "banner" edge of the File entity.
func (f *File) QueryBanner() *BannerQuery {
	return NewFileClient(f.config).QueryBanner(f)
}
