...
func (fu *FileUpdate) SetBannerID(id uint64) *FileUpdate {
	fu.mutation.SetBannerID(id)
	return fu
}

// SetNillableBannerID sets the "banner" edge to the Banner entity by ID if the given value is not nil.
func (fu *FileUpdate) SetNillableBannerID(id *uint64) *FileUpdate {
	if id != nil {
		fu = fu.SetBannerID(*id)
	}
	return fu
}

// SetBanner sets the "banner" edge to the Banner entity.
func (fu *FileUpdate) SetBanner(b *Banner) *FileUpdate {
	return fu.SetBannerID(b.ID)
}
...
func (fu *FileUpdate) ClearBanner() *FileUpdate {
	fu.mutation.ClearBanner()
	return fu
}
...
func (fu *FileUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if fu.mutation.BannerCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   file.BannerTable,
			Columns: []string{file.BannerColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
				IDSpec: sqlgraph.NewFieldSpec(banner.FieldID, field.TypeUint64),
			},
		}
		_spec.Edges.Clear = append(_spec.Edges.Clear, edge)
	}
	if nodes := fu.mutation.BannerIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   file.BannerTable,
...
// SetBannerID sets the "banner" edge to the Banner entity by ID.
func (fuo *FileUpdateOne) SetBannerID(id uint64) *FileUpdateOne {
	fuo.mutation.SetBannerID(id)
	return fuo
}

// SetNillableBannerID sets the "banner" edge to the Banner entity by ID if the given value is not nil.
func (fuo *FileUpdateOne) SetNillableBannerID(id *uint64) *FileUpdateOne {
	if id != nil {
		fuo = fuo.SetBannerID(*id)
	}
	return fuo
}

// SetBanner sets the "banner" edge to the Banner entity.
func (fuo *FileUpdateOne) SetBanner(b *Banner) *FileUpdateOne {
	return fuo.SetBannerID(b.ID)
}
...
// ClearBanner clears the "banner" edge to the Banner entity.
func (fuo *FileUpdateOne) ClearBanner() *FileUpdateOne {
	fuo.mutation.ClearBanner()
	return fuo
}
...
func (fuo *FileUpdateOne) sqlSave(ctx context.Context) (_node *File, err error) {
	...
	if nodes := fuo.mutation.BannerIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2O,
			Inverse: false,
			Table:   file.BannerTable,
