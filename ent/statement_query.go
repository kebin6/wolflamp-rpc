...
func (sq *StatementQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *StatementQuery) FirstIDX(ctx context.Context) uint64 {
...
func (sq *StatementQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (sq *StatementQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (sq *StatementQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (sq *StatementQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := sq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
//		GroupBy(statement.FieldCreatedAt).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
//
//	client.Statement.Query().
//		Select(statement.FieldCreatedAt).
//		Scan(ctx, &v)
...
func (sq *StatementQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(statement.Table, statement.Columns, sqlgraph.NewFieldSpec(statement.FieldID, field.TypeUint64))
	_spec.From = sq.sql
