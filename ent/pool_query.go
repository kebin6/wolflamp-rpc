...
func (pq *PoolQuery) FirstID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (pq *PoolQuery) FirstIDX(ctx context.Context) uint64 {
...
func (pq *PoolQuery) OnlyID(ctx context.Context) (id uint64, err error) {
	var ids []uint64
...
func (pq *PoolQuery) OnlyIDX(ctx context.Context) uint64 {
...
func (pq *PoolQuery) IDs(ctx context.Context) (ids []uint64, err error) {
...
func (pq *PoolQuery) IDsX(ctx context.Context) []uint64 {
	ids, err := pq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (pq *PoolQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(pool.Table, pool.Columns, sqlgraph.NewFieldSpec(pool.FieldID, field.TypeUint64))
	_spec.From = pq.sql
