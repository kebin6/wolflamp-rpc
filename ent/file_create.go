...
func (fc *FileCreate) SetBannerID(id uint64) *FileCreate {
	fc.mutation.SetBannerID(id)
	return fc
}

// SetNillableBannerID sets the "banner" edge to the Banner entity by ID if the given value is not nil.
func (fc *FileCreate) SetNillableBannerID(id *uint64) *FileCreate {
	if id != nil {
		fc = fc.SetBannerID(*id)
	}
	return fc
}

// SetBanner sets the "banner" edge to the Banner entity.
func (fc *FileCreate) SetBanner(b *Banner) *FileCreate {
	return fc.SetBannerID(b.ID)
}
...
func (fc *FileCreate) createSpec() (*File, *sqlgraph.CreateSpec) {
	...
	if nodes := fc.mutation.BannerIDs(); len(nodes) > 0 {
